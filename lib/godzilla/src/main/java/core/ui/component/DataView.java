...
public class DataView extends JTable {
    ...
    public void find(String regxString) {
        if (!regxString.isEmpty()) {
            TableRowSorter<DefaultTableModel> sorter2 = new TableRowSorter<>(DataView.super.getModel());
            setRowSorter(sorter2);
            sorter2.setRowFilter(RowFilter.regexFilter(regxString, new int[0]));
            return;
        }
        TableRowSorter<DefaultTableModel> sorter3 = new TableRowSorter<>(DataView.super.getModel());
        setRowSorter(sorter3);
        sorter3.setRowFilter((RowFilter) null);
    }
    ...
    public JTableHeader getTableHeader() {
        JTableHeader tableHeader = DataView.super.getTableHeader();
    ...
    public TableCellRenderer getDefaultRenderer(Class<?> columnClass) {
        DefaultTableCellRenderer cr = DataView.super.getDefaultRenderer(columnClass);
