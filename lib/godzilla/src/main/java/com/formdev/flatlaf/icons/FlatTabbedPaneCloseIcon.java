...
public class FlatTabbedPaneCloseIcon extends FlatAbstractIcon {
    ...
    public void paintIcon(Component c, Graphics2D g) {
        ...
        g.setColor(FlatUIUtils.deriveColor(FlatButtonUI.buttonStateColor(c, this.foreground, null, null, this.hoverForeground, this.pressedForeground), c.getForeground()));
