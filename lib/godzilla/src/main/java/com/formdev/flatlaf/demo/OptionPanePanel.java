...
public class OptionPanePanel extends JPanel {
    ...
    private void initComponents() {
        ...
        panel9.setLayout(new MigLayout("flowy,insets dialog,hidemode 3", "[][][fill]", "[top][top][top][top][top][top][top][top]"));
    ...
    public static class ShowDialogLinkLabel extends JLabel {
        ...
        ShowDialogLinkLabel() {
            ...
            addMouseListener(new MouseAdapter() {
                /* class com.formdev.flatlaf.demo.OptionPanePanel.ShowDialogLinkLabel.AnonymousClass1 */
        ...
        private void showDialog() {
            ...
            if (this.optionPane.getWantsInput()) {
                JOptionPane.showInputDialog(window, this.optionPane.getMessage(), this.titleLabel.getText() + " Title", this.optionPane.getMessageType(), this.optionPane.getIcon(), (Object[]) null, (Object) null);
            } else {
                JOptionPane.showOptionDialog(window, this.optionPane.getMessage(), this.titleLabel.getText() + " Title", this.optionPane.getOptionType(), this.optionPane.getMessageType(), this.optionPane.getIcon(), this.optionPane.getOptions(), this.optionPane.getInitialValue());
            }
        }
        ...
        public void setTitleLabel(JLabel titleLabel2) {
            this.titleLabel = titleLabel2;
        }
        ...
        public void setOptionPane(JOptionPane optionPane2) {
            this.optionPane = optionPane2;
        }
    }
}
