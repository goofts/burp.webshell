...
class BasicComponentsPanel extends JPanel {
    ...
    private void initComponents() {
        ...
        setLayout(new MigLayout("insets dialog,hidemode 3", "[sizegroup 1][sizegroup 1][sizegroup 1][sizegroup 1][][]", "[][][][][][][][][][][][]para[][]"));
        ...
        button14.setText(Strings.NO_ELLIPSIS_STRING);
        add(button14, "cell 5 1");
        button15.setText(Strings.ELLIPSIS_STRING);
        ...
        comboBox1.setModel(new DefaultComboBoxModel(new String[]{"Editable", A.TAG_NAME, "bb", "ccc"}));
        add(comboBox1, "cell 1 4,growx");
        comboBox2.setEditable(true);
        comboBox2.setEnabled(false);
        comboBox2.setModel(new DefaultComboBoxModel(new String[]{"Disabled", A.TAG_NAME, "bb", "ccc"}));
        add(comboBox2, "cell 2 4,growx");
        comboBox3.setModel(new DefaultComboBoxModel(new String[]{"Not editable", A.TAG_NAME, "bb", "ccc"}));
        add(comboBox3, "cell 3 4,growx");
        comboBox4.setModel(new DefaultComboBoxModel(new String[]{"Not editable disabled", A.TAG_NAME, "bb", "ccc"}));
        ...
        if (FlatLafDemo.screenshotsMode) {
            ...
            for (int i2 = 0; i2 < passwordFields.length; i2++) {
                layout.setComponentConstraints(passwordFields[i2], layout.getComponentConstraints(formattedTextFields[i2]));
            }
        }
    }
}
