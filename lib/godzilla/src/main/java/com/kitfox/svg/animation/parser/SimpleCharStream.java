...
public class SimpleCharStream extends AbstractCharStream {
    ...
    @Override // com.kitfox.svg.animation.parser.AbstractCharStream
    public int streamRead(char[] buffer, int offset, int len) throws IOException {
    ...
    @Override // com.kitfox.svg.animation.parser.AbstractCharStream, com.kitfox.svg.animation.parser.CharStream
