...
public class ArrayMemberValue extends MemberValue {
    ...
    public Object getValue(ClassLoader cl, ClassPool cp, Method method) throws ClassNotFoundException {
        Class<?> clazz;
        if (this.values == null) {
    ...
    public Class<?> getType(ClassLoader cl) throws ClassNotFoundException {
        if (this.type != null) {
            return Array.newInstance(this.type.getType(cl), 0).getClass();
        }
