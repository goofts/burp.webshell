...
public class Frame {
    ...
    public Frame(int locals2, int stack2) {
        this.locals = new Type[locals2];
        this.stack = new Type[stack2];
    }
    ...
    /* access modifiers changed from: package-private */
    public void setJsrMerged(boolean jsrMerged2) {
        this.jsrMerged = jsrMerged2;
    }
    ...
    /* access modifiers changed from: package-private */
    public void setRetMerged(boolean retMerged2) {
        this.retMerged = retMerged2;
    }
}
