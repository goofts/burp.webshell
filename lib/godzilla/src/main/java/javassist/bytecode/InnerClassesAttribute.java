...
public class InnerClassesAttribute extends AttributeInfo {
    ...
    public void append(String inner, String outer, String name, int flags) {
        append(this.constPool.addClassInfo(inner), this.constPool.addClassInfo(outer), this.constPool.addUtf8Info(name), flags);
    }
    ...
    public void append(int inner, int outer, int name, int flags) {
        ...
        ByteArray.write16bit(ByteArray.readU16bit(data, 0) + 1, newData, 0);
