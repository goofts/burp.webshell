...
public class TypeChecker extends Visitor implements Opcode, TokenId {
    ...
    public static ASTree getConstantFieldValue(CtField f) {
        ...
        if ((value instanceof Double) || (value instanceof Float)) {
            return new DoubleConst(((Number) value).doubleValue(), value instanceof Double ? TokenId.DoubleConstant : TokenId.FloatConstant);
        } else if (value instanceof Number) {
            return new IntConst(((Number) value).longValue(), value instanceof Long ? TokenId.LongConstant : TokenId.IntConstant);
    ...
    private static boolean isPlusExpr(ASTree expr) {
        if (!(expr instanceof BinExpr) || ((BinExpr) expr).getOperator() != 43) {
            return false;
        }
        return true;
    }
    ...
    /* access modifiers changed from: protected */
    public CtField fieldAccess(ASTree expr) throws CompileError {
    ...
    /* access modifiers changed from: protected */
    public void atFieldPlusPlus(ASTree oprand) throws CompileError {
