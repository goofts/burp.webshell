...
public abstract class CtClass {
    ...
    public static CtClass byteType = new CtPrimitiveType("byte", 'B', "java.lang.Byte", "byteValue", "()B", Opcode.IRETURN, 8, 1);
    public static CtClass charType = new CtPrimitiveType("char", 'C', "java.lang.Character", "charValue", "()C", Opcode.IRETURN, 5, 1);
    public static String debugDump = null;
    public static CtClass doubleType = new CtPrimitiveType("double", 'D', "java.lang.Double", "doubleValue", "()D", Opcode.DRETURN, 7, 2);
    public static CtClass floatType = new CtPrimitiveType("float", 'F', "java.lang.Float", "floatValue", "()F", Opcode.FRETURN, 6, 1);
    public static CtClass intType = new CtPrimitiveType("int", 'I', "java.lang.Integer", "intValue", "()I", Opcode.IRETURN, 10, 1);
    static final String javaLangObject = "java.lang.Object";
    public static CtClass longType = new CtPrimitiveType("long", 'J', "java.lang.Long", "longValue", "()J", Opcode.LRETURN, 11, 2);
    static CtClass[] primitiveTypes = new CtClass[9];
    public static CtClass shortType = new CtPrimitiveType("short", 'S', "java.lang.Short", "shortValue", "()S", Opcode.IRETURN, 9, 1);
    public static final String version = "3.27.0-GA";
    public static CtClass voidType = new CtPrimitiveType("void", 'V', "java.lang.Void", null, null, Opcode.RETURN, 0, 0);
    ...
    public synchronized Collection<String> getRefClasses() {
        ...
        if (cf != null) {
            ClassMap cm = new ClassMap() {
                /* class javassist.CtClass.AnonymousClass1 */
                ...
                @Override // java.util.AbstractMap, javassist.ClassMap, javassist.ClassMap, java.util.Map, java.util.HashMap
    ...
    public CtConstructor getDeclaredConstructor(CtClass[] params) throws NotFoundException {
        return getConstructor(Descriptor.ofConstructor(params));
    }
    ...
    public DataOutputStream makeFileOutput(String directoryName) {
        String filename = directoryName + File.separatorChar + getName().replace('.', File.separatorChar) + ".class";
