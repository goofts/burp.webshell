...
@PluginAnnotation(Name = "PMeterpreter", payloadName = "PhpDynamicPayload")
    ...
    private void goButtonClick(ActionEvent actionEvent) {
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                String resultString = Meterpreter.this.encoding.Decoding(Meterpreter.this.payload.evalFunc(Meterpreter.CLASS_NAME, "run", reqParamete));
