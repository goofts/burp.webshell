...
public class SQLiteConfig {
    ...
    public void apply(Connection conn) throws SQLException {
        ...
        try {
            ...
            for (Object each2 : this.pragmaTable.keySet()) {
                ...
                if (pragmaParams.contains(key) && (value = this.pragmaTable.getProperty(key)) != null) {
    ...
    static DriverPropertyInfo[] getDriverPropertyInfo() {
        DriverPropertyInfo[] result = new DriverPropertyInfo[Pragma.values().length];
    ...
    public enum Pragma {
        ...
        ENCODING("encoding", SQLiteConfig.toStringArray(Encoding.values())),
        ...
        HEXKEY_MODE("hexkey_mode", SQLiteConfig.toStringArray(HexKeyMode.values())),
        ...
        private Pragma(String pragmaName2) {
            this(pragmaName2, null);
        }

        private Pragma(String pragmaName2, String[] choices2) {
            this(pragmaName2, null, choices2);
        }

        private Pragma(String pragmaName2, String description2, String[] choices2) {
            this.pragmaName = pragmaName2;
    ...
    /* access modifiers changed from: private */
    public static String[] toStringArray(PragmaValue[] list) {
    ...
    public enum Encoding implements PragmaValue {
        ...
        private Encoding(String typeName2) {
